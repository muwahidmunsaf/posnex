...
<tr>
    <td class="header">
        <a href="<?php echo new \Illuminate\Support\EncodedHtmlString($url); ?>" style="display: inline-block;">
            <img src="<?php echo new \Illuminate\Support\EncodedHtmlString(asset('logo.png')); ?>" class="logo" alt="Irshad Autos Logo" style="height: 60px;">
        </a>
    </td>
</tr>
<?php /**PATH C:\Users\HP\Desktop\posnex\resources\views/vendor/mail/html/header.blade.php ENDPATH**/ ?>
...
<div class="header">
    ...
    <div class="company-details">
        ...
        <div><b>Printed:</b> <?php echo e(now()->format('d M, Y H:i')); ?></div>
        <?php if($from || $to): ?>
            <div>
                <b>Date Range:</b>
                <?php if($from && $to): ?>
                    <?php echo e(\Carbon\Carbon::parse($from)->format('d M, Y')); ?> to <?php echo e(\Carbon\Carbon::parse($to)->format('d M, Y')); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var chartData = [
        ...
        <?php echo e($totalInternalPurchases); ?>,
...
</html> <?php /**PATH C:\Users\HP\Desktop\posnex\resources\views/dashboard/print.blade.php ENDPATH**/ ?>
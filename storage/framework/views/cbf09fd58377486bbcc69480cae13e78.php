            ...
            <ul class="navbar-nav ms-auto">
                ...
                <?php else: ?>
                    ...
                    <?php if($user && $user->role !== 'employee'): ?>
                        <li class="nav-item">
                            <a class="btn mt-2 me-3 btn-danger" href="<?php echo e(url('/dashboard')); ?>">Dashboard</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                            ...
                            <?php if($user && $user->role == 'superadmin'): ?>
                                <li><a class="dropdown-item" href="<?php echo e(route('companies.index')); ?>">Companies</a></li>
...
<?php /**PATH C:\Users\HP\Desktop\posnex\resources\views/includes/posNavbar.blade.php ENDPATH**/ ?>
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h2 class="fw-bold mb-1" style="font-size:2.1rem;color:#b71c1c;">{{ $companyName }} Dashboard</h2>
                    <div class="text-muted" style="font-size:1.1rem;">Welcome back, <strong>{{ auth()->user()->name }}</strong>! Here’s a quick overview of your company’s performance.</div>
                </div>
            </div>
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="{{ route('dashboard.print', request()->only(['from','to'])) }}" target="_blank" class="btn btn-light border shadow-sm" title="Print Dashboard" style="font-size:1.3rem;"><i class="bi bi-printer"></i></a>
            </div>
        </div>
        <!-- Date Filter Modal -->
        ...
        <div class="dashboard-row mb-4" style="gap:14px; display:flex; flex-wrap:wrap; justify-content:space-between;">
            <a href="{{ route('suppliers.index') }}" class="dashboard-stat text-decoration-none flex-grow-1 flex-basis-0" style="min-width:120px;">
            ...
            <a href="{{ route('distributors.index') }}" class="dashboard-stat text-decoration-none flex-grow-1 flex-basis-0" style="min-width:120px;">
            ...
            <a href="{{ route('shopkeepers.index') }}" class="dashboard-stat text-decoration-none flex-grow-1 flex-basis-0" style="min-width:120px;">
            ...
            <a href="{{ route('customers.index') }}" class="dashboard-stat text-decoration-none flex-grow-1 flex-basis-0" style="min-width:120px;">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
            <div class="col">
                <a href="{{ route('sales.index') }}" class="card dashboard-card text-center border-0 text-decoration-none" style="background: linear-gradient(135deg, #e0f7fa 60%, #b2ebf2 100%);">
                    <div class="card-body">
            ...
            <div class="col">
                <a href="{{ route('sales.index') }}" class="card dashboard-card text-center border-0 text-decoration-none" style="background: linear-gradient(135deg, #e3fcec 60%, #b2f2bb 100%);">
                    <div class="card-body">
            ...
            <div class="col">
                <a href="{{ route('sales.index') }}" class="card dashboard-card text-center border-0 text-decoration-none" style="background: linear-gradient(135deg, #fffbe7 60%, #ffe082 100%);">
                    <div class="card-body">
            ...
            <div class="col">
                <a href="{{ route('expenses.index') }}" class="card dashboard-card text-center border-0 text-decoration-none" style="background: linear-gradient(135deg, #ffeaea 60%, #ffbaba 100%);">
                    <div class="card-body">
            ...
            <div class="col">
                <a href="{{ route('reports.finance') }}" class="card dashboard-card text-center border-0 text-decoration-none" style="background: linear-gradient(135deg, #e3fcec 60%, #b2f2bb 100%);">
                    <div class="card-body">
            ...
            <div class="col">
                <a href="{{ route('reports.finance') }}" class="card dashboard-card text-center border-0 text-decoration-none" style="background: linear-gradient(135deg, #fffde7 60%, #fff9c4 100%);">
                    <div class="card-body">
            ...
            <div class="col">
                <a href="{{ route('suppliers.index') }}" class="card dashboard-card text-center border-0 text-decoration-none" style="background: linear-gradient(135deg, #f3e5f5 60%, #ce93d8 100%);">
                    <div class="card-body">

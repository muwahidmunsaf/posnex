...
@section('pos')
    <div class="container py-4">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('external-sales.store') }}">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" name="purchase_amount" class="form-control" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Purchase Source</label>
                                <input type="text" name="purchase_source" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <h5>SALE</h5>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" id="selected_customer_name" class="form-control"
                                        placeholder="Select customer..." readonly required>
                                    <input type="hidden" name="customer_id" id="selected_customer_id">
                                    <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal"
                                        data-bs-target="#customerModal">Search</button>
                                </div>
                            </div>
                        ...
                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-success px-4">
                                <i class="bi bi-save me-1"></i> Create Sale
                            </button>
                        </div>
                </form>
            </div>
                        ...
                        @foreach ($customers as $customer)
                            <li class="list-group-item customer-item" data-id="{{ $customer->id }}"
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <small class="text-muted">{{ $customer->type }} |
                                        {{ $customer->cel_no ?? 'No phone' }}</small>
                                </div>
                            </li>
                        @endforeach
                    </ul>

        ...
        @else
            <form method="POST" action="{{ route('company.settings.update') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input name="taxCash" value="{{ old('taxCash', $company->tax_cash) }}" class="form-control">
                </div>

                <div class="mb-3">
                    <label>Tax % (Card)</label>
                    <input name="taxCard" value="{{ old('taxCard', $company->tax_card) }}" class="form-control">
                </div>

                <div class="mb-3">
                    <label>Tax % (Online)</label>
                    <input name="taxOnline" value="{{ old('taxOnline', $company->tax_online) }}" class="form-control">
                </div>
